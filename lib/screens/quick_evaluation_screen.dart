...
class QuickEvaluationScreen extends StatefulWidget {
  const QuickEvaluationScreen({super.key});
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const Text(
              'El registro clínico se ha sincronizado en Supabase y está listo para ser exportado.',
                  ...
                  children: [
                    pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text('The Clinical Sanctuary • Evaluación Rápida ATM', style: const pw.TextStyle(fontSize: 12)),
                      ],
                    ),
          ...
          children: [
            ...
            const Column(
              ...
              children: [
                ...
                Text(
                  'Evaluación Rápida • Screening ATM',
                  style: TextStyle(
                    fontSize: 10,
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        const Text(
                          '1. Nivel de dolor en la articulación ATM',
